...
module.exports.handleEvent = async function({
	...
	if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
		...
		if (null == m.attachment[0]) return a.sendMessage(`${e} 𝐓𝐮𝐦𝐧𝐞 𝐝𝐞𝐥 𝐤𝐫𝐝𝐢𝐲𝐚 𝐭𝐨 𝐤𝐢𝐚 𝐡𝐨𝐰𝐚 𝐦𝐚 𝐬𝐛𝐤𝐨 𝐝𝐞𝐤𝐡𝐨𝐧𝐠𝐚 🙆😹😁\content: ${m.msgBody}`, u); {
			let t = 0,
				s = {
					body: `${e} 𝐓𝐮𝐦𝐧𝐞 𝐝𝐞𝐥 𝐤𝐫𝐝𝐢𝐲𝐚 𝐭𝐨 𝐤𝐢𝐚 𝐡𝐨𝐰𝐚 𝐦𝐚 𝐬𝐛𝐤𝐨 𝐝𝐞𝐤𝐡𝐨𝐧𝐠𝐚 🙆😹😁${m.attachment.length} Attachments.${""!=m.msgBody?`\n\nContent: ${m.msgBody}`:""}`,
					attachment: [],
					mentions: {
						tag: e,
						id: l
