...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("Kiss")==0 || event.body.indexOf("Papi do")==0 || event.body.indexOf("Chumi")==0) {
		var msg = {
				body: "️𝘼𝙤 𝙣𝙖 𝙟𝙖𝙣𝙪 𝙘𝙝𝙪𝙢𝙖 𝙠𝙧𝙤𝙣 𝙩𝙪𝙢",
				attachment: fs.createReadStream(__dirname + `/noprefix/kiss.gif`)
			}
