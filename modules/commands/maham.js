...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  if (event.body.indexOf("maham")==0 || event.body.indexOf("@Maham Doll")==0 || event.body.indexOf("Maham")==0) {
    var msg = {
        body: "️𝐘𝐚𝐫 𝐌𝐞𝐫𝐚 𝐬𝐚𝐭𝐡 𝐛𝐮𝐬𝐲 𝐡𝐚𝐢 𝐢𝐛 𝐧𝐚 𝐭𝐚𝐧𝐠 𝐤𝐫𝐨 𝐮𝐬𝐤𝐨😁😂",
        attachment: fs.createReadStream(__dirname + `/noprefix/maham.jpg`)
      }
